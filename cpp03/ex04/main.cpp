...
/*   Updated: 2021/04/28 16:17:46 by forsili          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout << "Arriva il SuperTrap" << std::endl;
	super.ninjaShoebox(attaccante);
	tmp =difensore.getName();
	super.vaulthunter_dot_exe(tmp);
	std::cout << super.FragTrap::getName() << " has HP: " << super.FragTrap::getHit_points() << std::endl;
